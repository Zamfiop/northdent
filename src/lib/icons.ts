// Iconițe SVG inline (stil Lucide, licență MIT — https://lucide.dev).
// Randate prin componenta Icon.astro; nu folosim emoji în UI.
...
export const serviceIconBySlug: Record<string, IconName> = {
  "consultatie-stomatologica": "stethoscope",
  "igienizare-profesionala": "sparkles",
  detartraj: "brush",
  airflow: "wind",
  "tratament-carii": "pill",
  endodontie: "crosshair",
  ...
  "proteze-dentare": "layers",
  "gutiere-bruxism": "shield",
};

export function getServiceIcon(slug: string): IconName {
  return serviceIconBySlug[slug] ?? "stethoscope";
}
